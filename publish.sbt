...
pomExtra :=
  <url>https://github.com/hypertino/language-utils</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/language-utils.git</url>
      <connection>scm:git:git@github.com:hypertino/language-utils.git</connection>
    </scm>
    <developers>
      <developer>
        <id>maqdev</id>
